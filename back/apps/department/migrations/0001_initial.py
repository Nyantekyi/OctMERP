    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departmenttype', models.CharField(choices=[('Wholesale Unit', 'Wholesale Unit'), ('Retail Unit', 'Retail Unit'), ('Manufacturing Unit', 'Manufacturing Unit')], max_length=50)),
                ('description', models.TextField(blank=True)),
                ('base_markup', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_archived', models.BooleanField(default=False)),
                ('is_locked', models.BooleanField(default=False)),
                ('shift_types', models.CharField(choices=[('Morning Shift', 'Morning Shift'), ('Afternoon Shift', 'Afternoon Shift'), ('Evening Shift', 'Evening Shift'), ('Night Shift', 'Night Shift')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='branches', to='contact.address')),
                ('branchaccount', models.ManyToManyField(blank=True, related_name='branches', to='accounts.account')),
                ('contact', models.ManyToManyField(blank=True, related_name='branches', to='contact.contact')),
                ('sale_tax', models.ManyToManyField(blank=True, related_name='branches', to='accounts.tax')),
            ],
        ),
    ]
